...
import com.mins.spring.basics.springin5steps.cdi.SomeCdiBusiness;
...
public class SpringIn5StepsCdiApplication {
	...
	public static void main(String[] args) {
		...
		SomeCdiBusiness business = applicationContext.getBean(SomeCdiBusiness.class); //get bean from context, assign local var
